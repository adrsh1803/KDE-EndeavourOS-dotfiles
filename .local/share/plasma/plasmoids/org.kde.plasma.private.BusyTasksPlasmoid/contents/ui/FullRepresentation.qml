...
GridLayout
{
      ...
      onTriggered:
      {
         ...
         if(!meinProgramm.pausiert)
         {
            ...
            for (var i=0; i<6; ++i)
            {
               ...
               if (aktuelleIO1>=1)
                  repeaterIO.itemAt(i).children[0].width=liefereSkaliertenBalkenWert(aktuelleIO1);
               else
                  repeaterIO.itemAt(i).children[0].width=0;
               repeaterIO.itemAt(i).children[1].color=IOFarbe2;
               if (aktuelleIO2>=1)
                  repeaterIO.itemAt(i).children[1].width=liefereSkaliertenBalkenWert(aktuelleIO2);
               else
                  repeaterIO.itemAt(i).children[1].width=0;

               repeaterNET.itemAt(i).children[0].color=NETFarbe1;
               if (aktuelleNET1>=1)
                  repeaterNET.itemAt(i).children[0].width=liefereSkaliertenBalkenWert(aktuelleNET1);
               else
                  repeaterNET.itemAt(i).children[0].width=0;
               repeaterNET.itemAt(i).children[1].color=NETFarbe2;
               if (aktuelleNET2>=1)
                  repeaterNET.itemAt(i).children[1].width=liefereSkaliertenBalkenWert(aktuelleNET2);
               else
   ...
   MouseArea
   {
      ...
      onEntered:
      {
         ...
         popupFenster.x = globalc.x-75;
         popupFenster.y = globalc.y-popupFenster.height;
         popupFenster.show();
      }
   ...
   ApplicationWindow
   {
            ...
            Column
            {
               Rectangle
               {
                  ...
                  MouseArea
                  {
                     ...
                     onClicked:
                     {
                        if (filterTeil.visible==false)
                           filterTeil.visible = true;
                        else
                           filterTeil.visible = false;
                     }
                  }
               }
               Rectangle
               ...
               Rectangle
               {
                  ...
                  MouseArea
                  {
                     ...
                     onClicked:
                     {
                        if (mausX<38)
                        {
                           wechsleAnsichtNachLinks();
                        }
                        else
                        {
                           wechsleAnsichtNachRechts();
                        }
                     }
                     onWheel:
                     {
                        ...
                        ColumnLayout
                        {
                           ...
                           Row
                           {
                              Rectangle
                              {
                                 ...
                                 Rectangle
                                 {
                                    x: liefereSkaliertenBalkenWert(3)
                                    color: "#555555"
                                    height: 75
                                    width: 1
                                 }
                                 Rectangle
                                 {
                                    x: liefereSkaliertenBalkenWert(10)
                                    color: "#555555"
                                    height: 75
                                    width: 1
                                 }
                                 Rectangle
                                 {
                                    x: liefereSkaliertenBalkenWert(100)
                                    color: "#555555"
                                    height: 75
                                    width: 1
                                 }
                                 Rectangle
                                 {
                                    x: liefereSkaliertenBalkenWert(500)
                                    color: "#555555"
                                    height: 75
                                    width: 1
                                 }
                                 Rectangle
                                 {
                                    x: liefereSkaliertenBalkenWert2(3)
                                    color: "#555555"
                                    height: 75
                                    width: 1
                                 }
                                 Rectangle
                                 {
                                    x: liefereSkaliertenBalkenWert2(10)
                                    color: "#555555"
                                    height: 75
                                    width: 1
                                 }
                                 Rectangle
                                 {
                                    x:liefereSkaliertenBalkenWert2(100)
                                    color: "#555555"
                                    height: 75
                                    width: 1
                                 }
                                 Rectangle
                                 {
                                    x: liefereSkaliertenBalkenWert2(500)
                                    color: "#555555"
                                    height: 75
                                    width: 1
                                 }
      ...
      {
         id: textFenster
         width: popupFenster.width
         height: popupFenster.height
         background:
         Rectangle
         {
            color: "transparent"
         ...
         Timer
         {
            ...
            repeat: false
            running: false
            onTriggered: textFenster.close()
         }
      }
   }
   function liefereSkaliertenBalkenWert (Wert : real) : real
   {
      return (Math.pow(Math.log(Wert), 1.5)*9.1+3).toFixed(0);
   }
   function liefereSkaliertenBalkenWert2 (Wert : real) : real
   {
      return (Math.pow(Math.log(Wert), 1.5)*9.1+3+170).toFixed(0);
   }
   function wechsleAnsichtNachLinks()
   {
      if (meinProgramm.aktuelleAnzeige==1)
      {
         meinProgramm.aktuelleAnzeige=3;
         graph.visible=false;
         graphhistory.visible=false;
         prozessTeil.visible=true;
      }
      else if(meinProgramm.aktuelleAnzeige==2)
      {
         meinProgramm.aktuelleAnzeige=1;
         barGraphTeil.visible=false;
         graph.visible=true;
         graphhistory.visible=true;
      }
      else if(meinProgramm.aktuelleAnzeige==3)
      {
         meinProgramm.aktuelleAnzeige=2;
         prozessTeil.visible=false;
         barGraphTeil.visible=true;
      }
   }
   function wechsleAnsichtNachRechts()
   {
      if (meinProgramm.aktuelleAnzeige==1)
      {
         meinProgramm.aktuelleAnzeige=2;
